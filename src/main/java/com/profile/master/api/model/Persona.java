...
public class Persona {
    ...
    @ManyToMany(fetch = FetchType.LAZY)
    @JoinTable(name = "persona_skill", joinColumns = @JoinColumn(name = "id_persona", referencedColumnName = "idPersona"), inverseJoinColumns = @JoinColumn(name = "id_skill", referencedColumnName = "idSkill"))
